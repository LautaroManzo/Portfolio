...
const Projects = () => {
  return (
    <div id="projects" className="w-full flex flex-col items-center gap-6 p-6 backdrop-blur-[3px]">
      ...
      <div className="w-full flex flex-col items-center gap-8 px-2 sm:px-6">
        <AdivinaLaPalabra />
        <InProgress />
      </div>
